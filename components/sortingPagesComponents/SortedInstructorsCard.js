...
const birb = './assets/animalIcons/birb.png';
const bull = './assets/animalIcons/bull.png';
const crab = './assets/animalIcons/crab.png';
const fish = './assets/animalIcons/fish.png';
const fish1 = './assets/animalIcons/fish1.png';
const fish2 = './assets/animalIcons/fish2.png';
const fox = './assets/animalIcons/fox.png';
const hedgehog = './assets/animalIcons/hedgehog.png';
const hippopotamus = './assets/animalIcons/hippopotamus.png';
const koala = './assets/animalIcons/koala.png';
const lemur = './assets/animalIcons/lemur.png';
const moray = './assets/animalIcons/moray.png';
const octopus = './assets/animalIcons/octopus.png';
const pig = './assets/animalIcons/pig.png';
const prawn = './assets/animalIcons/prawn.png';
const seaweed = './assets/animalIcons/seaweed.png';
const tiger = './assets/animalIcons/tiger.png';
const turtle = './assets/animalIcons/turtle.png';
const whale = './assets/animalIcons/whale.png';
const whale1 = './assets/animalIcons/whale1.png';
const zebra = './assets/animalIcons/zebra.png';

const arrowDown = './assets/arrowDown.png';
